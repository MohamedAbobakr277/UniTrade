...
export default function SellTool() {
    ...
    const handleSubmit = async () => {
        ...
        const qty = parseInt(form.quantityAvailable);
        if (!form.quantityAvailable || isNaN(qty) || qty < 1) {
            setError("Available Quantity is required and must be at least 1.");
            return;
        }
            ...
            <Box sx={{ p: 5 }}>
                ...
                >
                    ...
                    <TextField
                        ...
                        helperText="How many units are available for sale? (minimum 1)"
                        sx={{ mb: 4 }}
                    />
